...
--Creamos un usuarios y le damos todos los privilegios.
CREATE USER 
'empleados1'@'localhost' 
IDENTIFIED  BY 'Empleados123$';

GRANT USAGE ON *.* TO 'empleados1'@'localhost';

ALTER USER 'empleados1'@'localhost' 
REQUIRE NONE 
